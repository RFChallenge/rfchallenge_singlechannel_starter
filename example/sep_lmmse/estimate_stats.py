...
# to run this file from within example/sep_lmmse folder
os.chdir(os.getcwd())
...
def load_train_frames(sig_type, num_train_instances):
    sig_dataset = []
...
def generate_samples(sig_dataset, block_len=block_len, window_len=window_len):
    block_dataset = []
